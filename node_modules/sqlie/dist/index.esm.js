...
class ModelBuilder {
    ...
    getById(id, columns) {
        ...
        return this.compositeKeys.reduce(function (selector, key) {
            ...
            return selector.where(key, '=', id[key]);
        }, this.get(columns));
    }
    delete(where) {
    ...
    deleteById(id) {
        ...
        return freezeBuilder(deleter, ModelBuilder.execute);
    }
    update(values) {
    ...
    updateById(id, values) {
        ...
        return this.compositeKeys.reduce(function (updater, key) {
            return updater.where(key, '=', composite(key, id));
        }, this.update(values));
    }
}
...
export { ModelBuilder, createModel, setQueryHandler, execute, ClauseBuilder, DeleteBuilder, InsertBuilder, SelectBuilder, JoinBuilder, JoinSelectBuilder, UpdateBuilder };
